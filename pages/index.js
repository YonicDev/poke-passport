...
export default function Home() {
  return (
    <div className={styles.main}>
        ...
        <img className={styles.logo} alt="PokéPassport" src="/poke-logo.svg" />
        <center>
            ...
            <nav className={styles.homeNavigation}>
                <Link href="/swsh/"><a className={styles.homeLink}><img alt="Pokémon Sword &amp; Shield" src="/swsh_banner.jpg" /></a></Link>
                <Link href="/visc/"><a className={styles.homeLink}><img alt="Pokémon Sword &amp; Shield" src="/visc_banner.png" /></a></Link>
            </nav>
        </center>
    </div>
  )
